...
# Inicia sesión en Hugging Face con el token de autenticación
...
# Se especifica que el modelo utilizará 'torch.bfloat16' para la precisión de los cálculos
# y se ejecutará en una GPU ('cuda')
pipeline = pipeline(
    "text-generation",
    model=model,
...
messages = [
    {"role": "user", "content": "Desarrolla un marco teórico para la integración de la inteligencia artificial en la toma de decisiones éticas en sistemas autónomos"},
]
